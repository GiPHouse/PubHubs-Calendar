const en = {
	...
	rooms: {
		...
		preview_file: 'File',
		preview_poll: 'Poll',
		preview_signed: 'Signed message',
		preview_unknown: 'Sent a message',
		discover: 'Discover rooms',
		room_library: 'Library for room:',
		no_rooms_found: 'No rooms were found',
		unread_messages: 'Unread Messages',
		last_read_message: 'Last read',
	...
	admin: {
		...
		ask_disclosure_yivi_message: 'An admin or steward asked you to share the following attributes',
		...
		disclosure_sign_message: 'The user disclosed some information:',
		disclosure_dialog_title: 'You have been asked to disclose some information',
		disclosure_message: 'The attributes you disclose will be shared to the follwing room: {0}',
		disclose: 'Click to disclose',
		private_room: 'private room',
		this_room: 'this room',
	...
	message: {
		...
		enable_announcement: 'Enable announcement mode',
		disable_announcement: 'Disable announcement mode',
	...
	roomlibrary: {
		...
		selected_files: '0 | 1 file selected | {count} files selected',
		total_files: 'No files | 1 file | {count} files',
		delete: {
			heading: 'Permanently delete file?',
			content: 'You are about to delete file {0}. <p class="font-bold">Beware! You cannot undo this.</p>',
			multiple_heading: 'Permanently delete these files?',
			multiple_content: 'You are about to delete {0} files.',
		},
		info: {
			sortby: 'Sort by',
			name: 'Name',
